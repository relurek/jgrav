...
///////////////////////Sourced from "paulevsGlitch"'s "BetterNether"
...
public final class Config {
	...
	private File getFile() {
		return new File(String.format("./config/%s/%s.json", JGrav.ID, name));
	}

	private File getFolder() {
		return new File("./config/" + JGrav.ID + "/");
	}
